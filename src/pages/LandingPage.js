  ...
  return (
    <div className="h-screen flex items-center sm:flex-col">
      ...
      <div className={`w-1/2 px-10 space-y-5 sm:w-screen `}>
        <h1>
          <b className="text-[#315da0] text-8xl">Wel</b>
          <b className="text-8xl text-gray-600">Come</b>
        </h1>
        <p className="text-lg">
        ...
        <div className="space-x-5">
          ...
          <button
            className="bg-[#315da0] px-10 py-3 text-white"
            onClick={() => {
      ...
      <div className="w-1/2 sm:w-screen">
        ...
        {showLoginForm && (
          <div className="ml-40 sm:ml-0">
            <div className="flex flex-col bg-sky-950 h-screen justify-center items-center px-20 space-y-5">
